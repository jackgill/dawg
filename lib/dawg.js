...
function render(chapters, options) {
    ...
    template = templating.compileTemplate(options.template, options.dev);
...
function serve(source, options) {
    ...
    function updateChapters(filename, filestat, event) {
    ...
    // Check if we need to watch the chapters
    //if (options.watch) {
        //watchPath(source, updateChapters);
    //}

    // Check if we need to watch the templates
    //if (options.dev) {
        //watchPath(options.template, function() {
            //console.log('Fetching template');
            //templating.compileTemplate(options.template, true);
        //});
    //}
