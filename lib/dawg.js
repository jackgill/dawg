...
function serve(source, options) {
    ...
    function updateChapters() {
        logger.log('Gathering chapters from ' + source);
    ...
    function renderChapters() {
        ...
        logger.log('Rerendering ' + chapters.length + ' chapters');
    ...
    logger.log('dawg listening on ' + options.host + ':' + options.port);
}
...
function convert(source, destination, options) {
    ...
    function converter() {
        logger.log('Converting ' + source + ' to ' + destination);
...
function cleanDestination(destination, unlink) {
    logger.log('Cleaning destination ' + destination);
...
function write(chapters, destination, options) {
    ...
    logger.log('Rendering ' + chapters.length + ' chapters');
    ...
    logger.log('Writing ' + chapters.length + ' chapters to ' + destination);
