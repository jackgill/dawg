...
module.exports.run = function run() {
    ...
    var args = cli
        ...
        .describe('port',  'Port for the webserver. Default: ' + PORT)
    ...
    // Create options from dawg's defaults
    var options = utils.defaults({}, dawg.defaults);
    ...
    if(options.output) {
        dawg.convert(options.source, options.output, options);
    }
}
